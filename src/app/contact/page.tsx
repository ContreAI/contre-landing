...
// Note: Metadata must be in a separate server component or use generateMetadata for client components
// For now, SEO is handled at layout level for this client component page
