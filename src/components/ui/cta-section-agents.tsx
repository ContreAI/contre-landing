...
export function CTASectionAgents() {
  return (
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-semibold font-['Bebas_Neue'] text-[#264E36] mb-6">
            See How Your Transaction Process Stacks Up Against the Top 10% of Agents
          </h2>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-slate-700 font-['Manrope'] max-w-2xl mx-auto mb-10">
            Take our 2-minute assessment to see how your transaction process compares to elite agents in your market—plus get a personalized roadmap to join them.
          </p>
