...
export function CTASectionAltBrokerages() {
  return (
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-semibold font-['Bebas_Neue'] text-white mb-6">
            See How We'd Catch the Risks in YOUR Actual Transactions
          </h2>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-white/90 font-['Manrope'] max-w-3xl mx-auto mb-10">
            15-minute demo using your real contracts. We'll show you exactly what critical details and conflicts our system would flag—before they become problems.
          </p>
          ...
          >
            <div className="relative p-[2px] bg-white rounded-2xl group-hover:bg-white/90 transition-all duration-300">
              <Button
                ...
                onClick={() => window.open('https://calendar.app.google/qgvuxMnfavvh14Uf6', '_blank')}
              >
                <motion.span
          ...
          >
            <span className="flex items-center gap-2">
              ...
              Bring your actual transaction docs
            </span>
            <span className="flex items-center gap-2">
              <span className="text-[#9DBFBF]">✓</span>
              See live analysis in real-time
            </span>
            <span className="flex items-center gap-2">
              <span className="text-[#9DBFBF]">✓</span>
              No sales pitch—just proof it works
            </span>
          </motion.div>
        </motion.div>
      </div>
