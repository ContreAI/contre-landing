...
const benefits = [
  ...
  "Red flags and conflicting terms highlighted automatically",
  "Shareable client chatbot activated instantly",
]
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-300 font-['Manrope'] max-w-2xl mx-auto mb-10 leading-relaxed">
            Upload your first contract and get a complete analysis in 60 seconds. Every deadline, every red flag, every conflict — surfaced before it costs you.
          </p>
        </motion.div>
