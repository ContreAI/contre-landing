...
const transformations = [
  {
    before: "Find out about issues when agents call you in a panic",
    after: "See flagged issues the moment they appear",
    metric: 100,
    metricSuffix: "%",
    metricLabel: "Proactive oversight",
  },
  {
    before: "Hope agents follow your standards and procedures",
    after: "Every document automatically reviewed against your standards",
    metric: 0,
    metricSuffix: "",
    metricLabel: "Documents that slip through",
  },
  {
    before: "Spend hours reviewing transactions manually",
    after: "AI reviews everything in real-time, you review exceptions",
    metric: 15,
    metricSuffix: "+",
...
export function BrokerageTransformation() {
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        >
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-semibold font-['Bebas_Neue'] text-[#264E36] tracking-wide mb-6">
            What Changes When You Turn Contre On
          </h2>
          <p className="text-lg md:text-xl text-slate-700 font-['Manrope'] max-w-2xl mx-auto">
            From reactive to proactive. From hoping to knowing.
          </p>
        </motion.div>
        ...
        >
          This is what brokerage oversight looks like in <span className="text-[#264E36] font-semibold">2026</span>.
        </motion.p>
      </div>
    </section>
  )
