...
export function BrokerageHero() {
  ...
  return (
    <section className="relative min-h-[calc(100vh-64px)] flex items-center bg-gradient-to-b from-slate-200 via-slate-100 to-slate-200 overflow-hidden py-0">
      {/* Ambient glow effects — spruce green on seaglass */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8 md:py-10 lg:py-12">
        <div className="lg:grid lg:grid-cols-[1fr_1.1fr] lg:gap-12 xl:gap-16 lg:items-center">
          ...
          >
            ...
            >
              <Building2 className="w-3.5 h-3.5 text-[#264E36]" aria-hidden="true" />
              <span className="text-xs font-['Manrope'] font-semibold text-[#264E36]">Built for Brokerage Owners &amp; Managing Brokers</span>
            </motion.div>

            {/* Headline */}
            <h1 className="font-['Bebas_Neue'] text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-[#264E36] tracking-wide leading-[1.05] mb-4">
              Every Transaction. Every Agent.{" "}
            ...
            <p className="text-base md:text-lg text-slate-700 font-['Manrope'] leading-relaxed mb-5 max-w-lg">
              AI trained on <strong className="text-[#264E36]">YOUR</strong> forms, <strong className="text-[#264E36]">YOUR</strong> deadlines, <strong className="text-[#264E36]">YOUR</strong> standards. Plugs into your existing workflow. Every document reviewed before it costs you.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center lg:items-start gap-3 mb-4">
              <div className="inline-block group relative">
                ...
                <Button
                  ...
                  onClick={() => { trackCTAClick('Start Training Your Docs'); window.open(`${APP_URL}/authentication/signup`, '_blank') }}
                >
                  <motion.span
                  ...
                  >
                    <span>Start Training Your Docs</span>
                    <motion.span
            ...
            >
              ...
              <span className="flex items-center gap-2">
                <span className="text-[#264E36]" aria-hidden="true">✓</span>
                Custom-trained on your standards
              </span>
            </motion.div>
          </motion.div>
            ...
            <div className="bg-[#0D1A14] rounded-2xl border border-white/[0.08] shadow-[0_8px_40px_rgba(0,0,0,0.3)] overflow-hidden">
              ...
              <div className="p-4 md:p-5 bg-gradient-to-b from-[#112A1E] to-[#0D1A14]">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <div className="text-xs font-['Manrope'] text-[#9DBFBF] font-semibold uppercase tracking-wider mb-1">Brokerage Overview</div>
                    <div className="text-sm font-['Manrope'] text-slate-500">Acme Realty Group — 32 Agents</div>
                  </div>
                  <motion.div
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  ...
                  >
                    <div className="font-['Bebas_Neue'] text-2xl text-[#9DBFBF]">
                      <AnimatedCounter target={14} delay={0.9} prefersReduced={prefersReduced} />
                    </div>
                    <div className="text-xs font-['Manrope'] text-slate-500 mt-1">Active Deals</div>
                  </motion.div>
                  <motion.div
                    initial={prefersReduced ? undefined : { opacity: 0, y: 10 }}
                    animate={prefersReduced ? undefined : { opacity: 1, y: 0 }}
                  ...
                  >
                    <div className="font-['Bebas_Neue'] text-2xl text-[#9DBFBF]">
                      <AnimatedCounter target={7} delay={1.1} prefersReduced={prefersReduced} />
                    </div>
                    <div className="text-xs font-['Manrope'] text-slate-500 mt-1">Due This Week</div>
                  </motion.div>
                </div>
                ...
                <div className="space-y-2.5">
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm font-['Manrope'] font-semibold text-slate-200">Missing seller disclosure — Agent: M. Johnson</div>
                      <div className="text-xs font-['Manrope'] text-slate-500 mt-0.5">456 Oak Ave · Due in 2 days</div>
                    </div>
                  </motion.div>
                  <motion.div
                    initial={prefersReduced ? undefined : { opacity: 0, x: -12 }}
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm font-['Manrope'] font-semibold text-slate-200">All documents verified — Agent: S. Chen</div>
                      <div className="text-xs font-['Manrope'] text-slate-500 mt-0.5">123 Main St · Closing in 5 days</div>
                    </div>
                  </motion.div>
                </div>
              </div>
