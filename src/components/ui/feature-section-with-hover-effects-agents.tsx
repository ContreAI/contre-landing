...
export function FeaturesSectionWithHoverEffectsAgents() {
  const features = [
    {
    ...
    {
      title: "40 hours per transaction on documents",
      description:
        "That's a full work week per deal. For a 30-agent brokerage doing 150 deals annually, that's 6,000 hours of unbillable time.",
